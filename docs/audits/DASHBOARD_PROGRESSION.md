...
| **Composants avec tokens** | ⚠️ 12/30 (40%) | 30/30 (100%) |
...
|----------|--------|-------------|-------|
| **Code dupliqué** | 1690 ▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓░░ | 0% | 230 |
| **Pages migrées** | 55% ▓▓▓▓▓▓▓▓▓▓▓░░░░░░░░░ | 0% | 100% |
| **Overlaps résolus** | 0/3 ░░░░░░░░░░░░░░░░░░░░ | 0% | 3/3 |
...
```
Sprint 1: Overlaps + UsersPage     ░░░░░░░░░░░░░░░░░░░░  0%
Sprint 2: Modals CoursesPage       ░░░░░░░░░░░░░░░░░░░░  0%
```

#### Sprint 1 - Overlaps + UsersPage (9h 30min)

- [ ] 🔴 **Supprimer StatusBadge.tsx** (30 min)
  - [ ] Vérifier qu'aucun usage n'existe
...
- [ ] 🟡 **Créer tokens FORM** (2h)
- [ ] 🟡 **Refactorer FormField** (2h)
- [ ] 🟡 **Refactorer SearchBar** (2h)
- [ ] 🟡 **Refactorer SelectField** (2h)
- [ ] 🟡 **Refactorer DateRangePicker** (2h)
- [ ] 🟡 **Créer tokens LAYOUT** (2h)
- [ ] 🟡 **Refactorer PageHeader** (2h)
- [ ] 🟡 **Refactorer autres Layout** (2h)

**Gain attendu:** Refactoring (pas de réduction de lignes)
...
| Overlaps composants | 260 | 80 | 0 | 180 |
| **TOTAL** | **1690** | **500** | **0** | **1190** |
...
1. **Supprimer StatusBadge.tsx** (30 min) → -80 lignes
   - Aucun usage trouvé, suppression sans risque

2. **Ajouter PageHeader à StorePage** (1h) → +UX cohérente
   - Changement minimal, impact visuel élevé

3. **Ajouter PageHeader à PaymentsPage** (1h) → +UX cohérente
   - Changement minimal, impact visuel élevé
