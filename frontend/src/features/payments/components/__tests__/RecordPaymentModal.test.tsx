 ...
 * Tests composant — payments / RecordPaymentModal
 * ─────────────────────────────────────────────────────────────────────────────
...
// Props détectées : isOpen, onClose, onSuccess, users, plans, onSubmit
...
describe('RecordPaymentModal', () => {
  ...
  it('devrait se rendre sans erreur avec les props minimales', () => {
    ...
    // const props = { isOpen: /* valeur */, onClose: /* valeur */, onSuccess: /* valeur */ /* ... + 3 autres */ };
