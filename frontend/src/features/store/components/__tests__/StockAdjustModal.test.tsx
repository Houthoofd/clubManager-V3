/**
 * StockAdjustModal.test.tsx
 * Tests composant — store / StockAdjustModal
 * ─────────────────────────────────────────────────────────────────────────────
...
// Props détectées : isOpen, onClose, stock, onSubmit
...
describe('StockAdjustModal', () => {
  ...
  it('devrait se rendre sans erreur avec les props minimales', () => {
    ...
    // const props = { isOpen: /* valeur */, onClose: /* valeur */, stock: /* valeur */ /* ... + 1 autres */ };

    // Act
    // render(<StockAdjustModal {...props} />);
