/**
 * SizeModal.test.tsx
 * Tests composant — store / SizeModal
 * ─────────────────────────────────────────────────────────────────────────────
...
// Props détectées : isOpen, onClose, size, onSubmit
...
describe('SizeModal', () => {
  ...
  it('devrait se rendre sans erreur avec les props minimales', () => {
    ...
    // const props = { isOpen: /* valeur */, onClose: /* valeur */, size: /* valeur */ /* ... + 1 autres */ };

    // Act
    // render(<SizeModal {...props} />);
