/**
 * QuickOrderExample.test.tsx
 * Tests composant — store / QuickOrderExample
 * ─────────────────────────────────────────────────────────────────────────────
...
import { QuickOrderExample } from '../modal-usage-examples';

// TODO: Importer les types de props si nécessaire

describe('QuickOrderExample', () => {
  ...
  it('devrait se rendre sans erreur avec les props minimales', () => {
    ...
    // Act
    // render(<QuickOrderExample {...props} />);
