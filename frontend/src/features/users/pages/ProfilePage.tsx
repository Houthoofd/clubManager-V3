...
export function ProfilePage() {
  ...
  const profileTabs: Tab[] = [
    {
      id: "profile",
      label: t("profile.tabProfile", "Mon profil"),
  ...
  return (
    <div className="space-y-6">
      ...
      <PageHeader
        ...
        description={`@${profile.nom_utilisateur}`}
      />

      {/* ── Main card: TabGroup + content ───────────────────────────────── */}
        ...
        {activeTab === "profile" && (
          <div className="p-6">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
              {/* ── LEFT: Info panel ───────────────────────────────── */}
              <div className="rounded-xl bg-gray-50 border border-gray-100 p-6 space-y-4">
                {/* Avatar + name + role */}
                ...
                <div className="pt-2 space-y-3">
                  <div className="flex items-start gap-3">
                    <div className="mt-0.5 h-7 w-7 rounded-md bg-gray-200 flex items-center justify-center flex-shrink-0">
                      <svg
