    ...
    <div className="flex flex-col h-full bg-white">
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 flex-shrink-0">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-1.5 text-sm text-red-600 hover:text-red-700 hover:bg-red-50 rounded-lg transition-colors border border-red-200 hover:border-red-300"
        >
          <span>🗑</span>
          <span>Supprimer</span>
        </button>
      ...
      <div className="px-6 py-5 border-b border-gray-100 flex-shrink-0">
        ...
        <dl className="space-y-2 text-sm">
          <div className="flex gap-2">
            <dt className="w-14 text-gray-500 font-medium flex-shrink-0">De :</dt>
          ...
          <div className="flex gap-2">
            <dt className="w-14 text-gray-500 font-medium flex-shrink-0">À :</dt>
            <dd className="text-gray-900">{message.destinataire_nom}</dd>
          </div>

          <div className="flex gap-2">
            <dt className="w-14 text-gray-500 font-medium flex-shrink-0">Date :</dt>
            <dd className="text-gray-600">{formatFullDate(message.created_at)}</dd>
          </div>
