/**
 * BroadcastNotificationModal.test.tsx
 * Tests composant — notifications / BroadcastNotificationModal
 * ─────────────────────────────────────────────────────────────────────────────
...
describe('BroadcastNotificationModal', () => {
  ...
  it('devrait se rendre sans erreur avec les props minimales', () => {
    ...
    // Act
    // render(<BroadcastNotificationModal {...props} />);
