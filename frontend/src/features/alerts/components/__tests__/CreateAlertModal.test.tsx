 ...
 * Tests composant — alerts / CreateAlertModal
 * ─────────────────────────────────────────────────────────────────────────────
...
// Props détectées : isOpen, onClose, alertTypes
...
describe('CreateAlertModal', () => {
  ...
  it('devrait se rendre sans erreur avec les props minimales', () => {
    ...
    // const props = { isOpen: /* valeur */, onClose: /* valeur */, alertTypes: /* valeur */ };

    // Act
    // render(<CreateAlertModal {...props} />);
