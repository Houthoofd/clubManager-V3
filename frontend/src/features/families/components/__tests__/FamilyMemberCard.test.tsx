 ...
 * Tests composant — families / FamilyMemberCard
 * ─────────────────────────────────────────────────────────────────────────────
...
// Props détectées : member, canRemove, onRemove, isRemoving
...
describe('FamilyMemberCard', () => {
  ...
  it('devrait se rendre sans erreur avec les props minimales', () => {
    ...
    // const props = { member: /* valeur */, canRemove: /* valeur */, onRemove: /* valeur */ /* ... + 1 autres */ };

    // Act
    // render(<FamilyMemberCard {...props} />);
  ...
  it('devrait afficher le contenu correct selon les props', () => {
    ...
    // ex: member = '<valeur_a>' → résultat attendu A
    // ex: member = '<valeur_b>' → résultat attendu B
    expect(true).toBe(true); // placeholder — à remplacer
  });
