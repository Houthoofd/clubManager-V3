...
export const getDashboardAnalytics = async (
  ...
  const response = await apiClient.get<DashboardAnalytics>('/statistics/dashboard', {
    params: {
...
export const getMemberAnalytics = async (
  ...
  const response = await apiClient.get<MemberAnalyticsResponse>('/statistics/members', {
    params: {
      date_debut: formatDateParam(params?.date_debut),
      date_fin: formatDateParam(params?.date_fin),
    },
...
export const getCourseAnalytics = async (
  ...
  const response = await apiClient.get<CourseAnalyticsResponse>('/statistics/courses', {
    params: {
      date_debut: formatDateParam(params?.date_debut),
      date_fin: formatDateParam(params?.date_fin),
    },
...
export const getFinancialAnalytics = async (
  ...
  const response = await apiClient.get<FinancialAnalyticsResponse>('/statistics/finance', {
    params: {
      date_debut: formatDateParam(params?.date_debut),
      date_fin: formatDateParam(params?.date_fin),
    },
...
export const getStoreAnalytics = async (
  ...
  const response = await apiClient.get<StoreAnalyticsResponse>('/statistics/store', {
    params: {
      date_debut: formatDateParam(params?.date_debut),
      date_fin: formatDateParam(params?.date_fin),
    },
...
export const getTrendAnalytics = async (
  ...
  const response = await apiClient.get<TrendAnalyticsResponse>('/statistics/trends', {
    params: {
      date_debut: formatDateParam(params?.date_debut),
      date_fin: formatDateParam(params?.date_fin),
 ...
 */
export const refreshStatistics = async (): Promise<{ success: boolean; message: string }> => {
