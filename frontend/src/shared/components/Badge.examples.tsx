    ...
    <div className="space-y-6 p-6 bg-gray-50">
      ...
      <div className="bg-white p-4 rounded-lg">
        ...
        <ul className="text-sm text-gray-600 space-y-1">
          <li>
            <strong>Success (Vert):</strong> Validé, actif, en stock, payé
          </li>
          <li>
            <strong>Warning (Jaune):</strong> En attente, stock bas, action
            requise
          </li>
          <li>
            <strong>Danger (Rouge):</strong> Erreur, annulé, rupture de stock
          </li>
          <li>
            <strong>Info (Bleu):</strong> Information, en cours de traitement
          </li>
          <li>
            <strong>Neutral (Gris):</strong> Défaut, inactif, autre
          </li>
          <li>
            <strong>Purple (Violet):</strong> Actions spéciales, remboursement
          </li>
          <li>
            <strong>Orange:</strong> Urgent, critique, attention
          </li>
        </ul>
      </div>
    </div>
    ...
    <div className="space-y-6 p-6 bg-gray-50">
      ...
      <div className="bg-white p-4 rounded-lg">
        ...
        <ul className="text-xs font-mono text-gray-600 space-y-1">
          <li>
            <strong>sm:</strong> px-2 py-0.5 text-xs
          </li>
          <li>
            <strong>md:</strong> px-2.5 py-0.5 text-xs (défaut)
          </li>
          <li>
            <strong>lg:</strong> px-3 py-1 text-sm
          </li>
        </ul>
      </div>
    </div>
    ...
    <div className="space-y-6 p-6 bg-gray-50">
      ...
      <div className="bg-blue-50 border border-blue-200 p-4 rounded-lg">
        <p className="text-sm text-blue-800">
          <strong>Usage:</strong> Le dot indicator (●) est idéal pour les
          statuts en temps réel comme la présence utilisateur, l'état de
          connexion, ou les notifications.
        </p>
      </div>
    </div>
  );
    ...
    <div className="space-y-6 p-6 bg-gray-50">
      ...
      <div className="bg-white p-4 rounded-lg">
        ...
        <p className="text-sm text-gray-600">
          Les icônes doivent avoir une classe{" "}
          <code className="bg-gray-100 px-1 rounded">h-3.5 w-3.5</code> pour
...
export function StatusBadgeExample() {
  return (
    <div className="space-y-6 p-6 bg-gray-50">
      <h2 className="text-2xl font-bold text-gray-900">
        Badge.Status (Statuts Génériques)
      </h2>
...
export function StockBadgeExample() {
  return (
    <div className="space-y-6 p-6 bg-gray-50">
      ...
      <div className="bg-blue-50 border border-blue-200 p-4 rounded-lg">
        <p className="text-sm text-blue-800">
          <strong>Automatique:</strong> Le badge change de couleur selon la
          quantité. Vert (&gt;10), Orange (≤10), Rouge (0). Seuil
          personnalisable avec{" "}
          <code className="bg-blue-100 px-1 rounded">threshold</code>.
        </p>
      </div>
    </div>
  );
...
export function RoleBadgeExample() {
  return (
    <div className="space-y-6 p-6 bg-gray-50">
      <h2 className="text-2xl font-bold text-gray-900">
        Badge.Role (Rôles Utilisateurs)
      </h2>

      <div className="flex flex-wrap items-center gap-3">
        <Badge.Role role="admin" />
        <Badge.Role role="professor" />
      ...
      <div className="bg-white p-4 rounded-lg">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <Badge.Role role="professor" size="sm" />
          </div>
          <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <Badge.Role role="member" size="sm" />
          </div>
        </div>
      </div>
    </div>
...
export function PaymentStatusBadgeExample() {
  return (
    <div className="space-y-6 p-6 bg-gray-50">
      <h2 className="text-2xl font-bold text-gray-900">
        Badge.PaymentStatus (Statuts de Paiement)
      </h2>

      <div className="flex flex-wrap items-center gap-3">
        <Badge.PaymentStatus status="en_attente" />
        <Badge.PaymentStatus status="valide" />
        <Badge.PaymentStatus status="paye" />
        <Badge.PaymentStatus status="partiel" />
        <Badge.PaymentStatus status="echoue" />
        <Badge.PaymentStatus status="rembourse" />
        <Badge.PaymentStatus status="annule" />
      </div>
      ...
      <div className="bg-white p-4 rounded-lg">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            ...
            <Badge.PaymentStatus status="valide" size="sm" />
          </div>
          <div className="flex items-center justify-between">
            <span className="text-sm text-gray-700">
              Cours de Guitare - 45€
            </span>
            <Badge.PaymentStatus status="en_attente" size="sm" />
          </div>
          <div className="flex items-center justify-between">
            <span className="text-sm text-gray-700">Cours de Violon - 60€</span>
            <Badge.PaymentStatus status="echoue" size="sm" />
          </div>
          <div className="flex items-center justify-between">
            <span className="text-sm text-gray-700">
              Cours de Batterie - 55€
            </span>
            <Badge.PaymentStatus status="rembourse" size="sm" />
          </div>
          <div className="flex items-center justify-between">
            <span className="text-sm text-gray-700">
              Cours de Saxophone - 40€
            </span>
            <Badge.PaymentStatus status="partiel" size="sm" />
          </div>
          <div className="flex items-center justify-between">
            <span className="text-sm text-gray-700">Cours de Flûte - 35€</span>
            <Badge.PaymentStatus status="annule" size="sm" />
          </div>
        </div>
      </div>
    </div>
...
export function OrderStatusBadgeExample() {
  return (
    <div className="space-y-6 p-6 bg-gray-50">
      <h2 className="text-2xl font-bold text-gray-900">
        Badge.OrderStatus (Statuts de Commande)
      </h2>
...
export function ProductGridExample() {
  ...
  return (
    <div className="space-y-6 p-6 bg-gray-50">
      <h2 className="text-2xl font-bold text-gray-900">
        Usage Pratique - Grille de Produits
      </h2>
      ...
      <div className="max-w-7xl mx-auto py-12 space-y-12">
        <div className="px-6">
          ...
          <p className="text-lg text-gray-600">
            Galerie complète de tous les variants, tailles et usages du
            composant Badge
          </p>
        </div>
