/**
 * ConfirmEmailChangeUseCase.test.ts
 * Tests unitaires — auth / ConfirmEmailChangeUseCase
 * ─────────────────────────────────────────────────────────────────────────────
...
beforeEach(() => {
  useCase = new ConfirmEmailChangeUseCase(mockRepo);
});
...
describe('ConfirmEmailChangeUseCase', () => {
  describe('execute', () => {
    ...
    it('devrait retourner le résultat quand les données sont valides', async () => {
      ...
      // const input: { token: string } = { /* TODO: renseigner les paramètres */ };
