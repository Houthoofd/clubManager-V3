/**
 * GetAuthAttemptsUseCase.test.ts
 * Tests unitaires — auth / GetAuthAttemptsUseCase
 * ─────────────────────────────────────────────────────────────────────────────
...
import { GetAuthAttemptsUseCase } from "../GetAuthAttemptsUseCase";
...
beforeEach(() => {
  useCase = new GetAuthAttemptsUseCase(mockRepo);
});
