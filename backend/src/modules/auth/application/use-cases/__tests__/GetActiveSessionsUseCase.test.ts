/**
 * GetActiveSessionsUseCase.test.ts
 * Tests unitaires — auth / GetActiveSessionsUseCase
 * ─────────────────────────────────────────────────────────────────────────────
...
import { GetActiveSessionsUseCase } from '../GetActiveSessionsUseCase';
...
beforeEach(() => {
  useCase = new GetActiveSessionsUseCase(mockRepo);
});
